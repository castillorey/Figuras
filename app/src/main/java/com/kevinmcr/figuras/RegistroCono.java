...
public class RegistroCono extends AppCompatActivity {
    ...
    public void guardar (View v){
        ...
        if(Double.parseDouble(_altura) == 0){
            ...
            resultado = Metodos.operacionVolumenCono(_radio,_altura, recursos);
            ...
            alertDialogBuilder.setPositiveButton("Ok",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            Toast.makeText(RegistroCono.this,getResources().getString(R.string.mensaje_guardado),Toast.LENGTH_LONG).show();
                        }
                    }
            );
